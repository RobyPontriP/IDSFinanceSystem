<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfFARepYearly.aspx.cs" Inherits="IDS.Web.UI.Report.FixedAsset.wfFARepYearly" MasterPageFile="~/Report/Template/ReportMaster.Master"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="row mb-2">
        <div class="col-sm-6 col-md-6 col-6">
            <h4>Yearly Depreciation Report</h4>
        </div>
    </div>
