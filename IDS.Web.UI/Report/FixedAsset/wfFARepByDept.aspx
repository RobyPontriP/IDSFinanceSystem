<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfFARepByDept.aspx.cs" Inherits="IDS.Web.UI.Report.FixedAsset.wfFARepByDept"  MasterPageFile="~/Report/Template/ReportMaster.Master"%>
<%@Register Assembly="CrystalDecisions.Web, Version=13.0.4000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" 
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    
    <div class="col-sm-6 col-md-6 col-6">
        <h4>FA Report by Dept</h4>
    </div>
            ...
            <div class="row mb-0">
                ...
                <div class="form-group row col-sm-3">
                    <label for="cboMontYear" class="col-form-label col-form-label-sm col-sm-4">Year</label>
                    <div class="col-sm-8">
                        <%--<asp:TextBox ID="cboMontYear" runat="server" CssClass="form-control form-control-sm"></asp:TextBox>--%>
                        <%--<asp:DropDownList AutoPostBack="false"  ID="cboMontYear" runat="server" CssClass="form-control form-control-sm pl-15"></asp:DropDownList>--%>
                ...
                <div class="form-group row col-sm-3">
                    <label for="cboXDept" class="col-form-label col-form-label-sm col-sm-4">Department</label>
                    <div class="col-sm-8">
                         <asp:DropDownList AutoPostBack="false"  ID="cboXDept" runat="server" CssClass="form-control form-control-sm"></asp:DropDownList>
                    </div>
                </div>
