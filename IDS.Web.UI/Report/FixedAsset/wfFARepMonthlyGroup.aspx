<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfFARepMonthlyGroup.aspx.cs" Inherits="IDS.Web.UI.Report.FixedAsset.wfFARepMonthlyGroup" MasterPageFile="~/Report/Template/ReportMaster.Master"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="row mb-2">
        <div class="col-sm-6 col-md-6 col-6">
            <h4>Monthly Depreciation Report by Group</h4>
        </div>
    </div>

      <div class="row mb-0">
                <div class="form-group row col-sm-3">
                    <label for="cboMontYear" class="col-form-label col-form-label-sm col-sm-4">Period</label>
                    <div class="col-sm-8">
