<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfFARepByLocation.aspx.cs" Inherits="IDS.Web.UI.Report.FixedAsset.wfFARepByLocation" MasterPageFile="~/Report/Template/ReportMaster.Master" %>
<%@Register Assembly="CrystalDecisions.Web, Version=13.0.4000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" 
    Namespace="CrystalDecisions.Web" TagPrefix="CR" %>
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    
    <div class="col-sm-6 col-md-6 col-6">
        <h4>Fixed Asset List by Location</h4>
    </div>
            ...
            <div class="row mb-0">
                ...
                <div class="form-group row col-sm-3">
                    <label for="cboXLocation" class="col-form-label col-form-label-sm col-sm-3">Location</label>
                    <div class="col-sm-9">
                        <asp:DropDownList AutoPostBack="false"  ID="cboXLocation" runat="server" CssClass="form-control form-control-sm pl-15"></asp:DropDownList>
                    </div>
                </div>
