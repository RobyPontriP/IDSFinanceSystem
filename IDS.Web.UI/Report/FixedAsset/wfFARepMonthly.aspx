<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfFARepMonthly.aspx.cs" Inherits="IDS.Web.UI.Report.FixedAsset.wfFARepMonthly" MasterPageFile="~/Report/Template/ReportMaster.Master"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="row mb-2">
        <div class="col-sm-6 col-md-6 col-6">
            <h4>Monthly Depreciation Table Report</h4>
        </div>
    </div>
      ...
      <div class="row mb-0">
                ...
                <div class="col-sm-6 text_right float-right">
