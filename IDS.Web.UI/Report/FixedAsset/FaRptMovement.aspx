<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FaRptMovement.aspx.cs" Inherits="IDS.Web.UI.Report.FixedAsset.FaRptMovement" MasterPageFile="~/Report/Template/ReportMaster.Master"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="row mb-2">
        <div class="col-sm-6 col-md-6 col-6">
            <h4>Detailed Acquisition and Sold Fixed Assets</h4>
        </div>
    </div>
