...
{
    public partial class wfFARepMonthly : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            this.Page.Title = "Monthly Depreciation Report";
            if (!IsPostBack)
            {
               FillBranch();
                Refresh();
        ...
        private void Refresh()
        {
            ...
            rpt.Load(Server.MapPath(@"~/Report/FixedAsset/CR/rptFAMonthly.rpt"));
