...
{
    public partial class wfFARepDeprAll : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            this.Page.Title = "Depreciation Expense";
            if (!IsPostBack)
            {
                FillBranch();
                Refresh();
        ...
        private void Refresh()
        {
            ...
            CrystalDecisions.CrystalReports.Engine.ReportDocument rpt = new CrystalDecisions.CrystalReports.Engine.ReportDocument();
            IDS.ReportHelper.CrystalHelper rptHelper = new IDS.ReportHelper.CrystalHelper();
            rpt.Load(Server.MapPath(@"~/Report/FixedAsset/CR/rptFADeprAll.rpt"));
            rpt.DataDefinition.FormulaFields["AtDate"].Text = "\"" + To_month + "-" + To_year + "\"";
