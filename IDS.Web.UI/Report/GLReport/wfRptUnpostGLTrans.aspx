<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptUnpostGLTrans.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptUnpostGLTrans" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
     ...
     <h4>
        <asp:Label ID="lblTitle" runat="server" >Unposted G/L Transaction</asp:Label>
    </h4>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group row mb-2">
                        <asp:Label ID="Label2" runat="server" Text="Ccy" CssClass="control-label col-sm-3 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-6">
