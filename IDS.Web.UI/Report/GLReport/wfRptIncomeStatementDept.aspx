<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptIncomeStatementDept.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptIncomeStatementDept" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-2">
                ...
                <div class="col-sm-4">
                    <div class="form-group row mb-2">
                        <asp:Label ID="Label6" runat="server" Text="Code" CssClass="control-label col-sm-3 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-3">
             ...
             <div class="row mb-2">
                ...
                <div class="col-sm-4">
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-4">
                            <asp:DropDownList ID="cboDept" runat="server" CssClass="form-control select2DDList"></asp:DropDownList>
                        </div>
                    </div>
                </div>
