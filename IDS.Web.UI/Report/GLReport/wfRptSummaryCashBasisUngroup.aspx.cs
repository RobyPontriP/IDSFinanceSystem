...
{
    public partial class wfRptSummaryCashBasisUngroup : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/RptSummaryCashBasesUngroup.rpt"));
        ...
        {
            this.Page.Title = "Summary Cash Basis With BI Code Report";
