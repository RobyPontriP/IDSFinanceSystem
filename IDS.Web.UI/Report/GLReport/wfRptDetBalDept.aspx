<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptDetBalDept.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptDetBalDept" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Detail Trial Balance For Department</asp:Label>
    </h4>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-1">
                ...
                <div class="col-sm-4">
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-6">
                            <asp:DropDownList ID="cboKarep" runat="server" CssClass="form-control select2DDList"></asp:DropDownList>
                        </div>
                    </div>
                </div>
            ...
            <div class ="row mb-2">
                 ...
                 <div class="col-sm-4">
                     <div class="form-group row mb-2">
                         <asp:Label ID="Label4" runat="server" Text="CCY From" CssClass="control-label col-sm-4 col-form-label" Font-Bold="true"></asp:Label>
                             <div class="col-sm-6">
                     ...
                     <div class="form-group row mb-2">
                         <asp:Label ID="Label5" runat="server" Text="CCY To" CssClass="control-label col-sm-4 col-form-label" Font-Bold="true"></asp:Label>
                         <div class="col-sm-6">
             ...
             <div class ="row mb-2">
                  <div class="col-sm-4"></div>
                   <div class="col-sm-4">
                           <asp:HiddenField id="hiddenCCY" runat="server" />
                   </div>
                  <div class="col-sm-4">
        ...
        $(document).ready(function () {
            ...
            function FillKarep() {
                ...
                $.ajax({
                    ...
                    success: function (respond) {
                        $.each(respond, function (i, item) {
                            $("#<%=cboKarep.ClientID %>").append('<option value = "' + item.Value + '">' + item.Value + '</option>');
                        });
                    },
                    error: function (xhr, test, response,aas) {
                    }
