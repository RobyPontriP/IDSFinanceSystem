...
{
    public partial class wfRptMonthlyBalance : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/RptMonthlyBalance.rpt"));
        ...
        {
            this.Page.Title = "Monthly Balance Report";
