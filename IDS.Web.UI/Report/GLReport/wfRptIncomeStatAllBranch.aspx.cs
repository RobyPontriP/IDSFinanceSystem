...
{
    public partial class wfRptIncomeStatAllBranch : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/RptIncomeStatementAllBranch.rpt"));
        ...
        {
            this.Page.Title = "Income Statement All Branch Report";
