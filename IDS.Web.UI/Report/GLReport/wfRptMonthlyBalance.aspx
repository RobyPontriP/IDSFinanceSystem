<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptMonthlyBalance.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptMonthlyBalance" MasterPageFile="~/Report/Template/ReportMaster.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Monthly Balance Report</asp:Label>
    </h4>
