...
{
    public partial class wfRptIncomeStat_ActualVsBudgetYearly : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    case "0301022300000000": //Void Invoice List
                        string judul_ = "Income Statement Actual Vs Budget Yearly";
                        ...
                        rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/Income_StatementActualVsBudgetYearly.rpt"));
