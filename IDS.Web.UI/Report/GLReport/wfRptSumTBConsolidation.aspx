<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptSumTBConsolidation.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptSumTBConsolidation" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-4">
                            <asp:Label ID="Label3" runat="server" Text="Print Zero Amount" CssClass="control-label col-sm-12 col-form-label" Font-Bold="true"></asp:Label>
                            <asp:CheckBox ID="chkPrintZeroAmt" runat="server" CssClass="form-check-inline" />
                        </div>

                        <div class="col-sm-3">
                            <asp:Label ID="Label2" runat="server" Text="Print All Field" CssClass="control-label col-sm-12 col-form-label" Font-Bold="true"></asp:Label>
                            <asp:CheckBox ID="chkPrintAllCol" runat="server" CssClass="form-check-inline" />
                        </div>
                    </div>
                </div>
