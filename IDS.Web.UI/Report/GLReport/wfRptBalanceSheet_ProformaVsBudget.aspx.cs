...
{
    public partial class wfRptBalanceSheet_ProformaVsBudget : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    case "0301022400000000":
                        string judul_ = "Balance Sheet Budget";
                        ...
                        rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/GLRepBalSBudgetYearly.rpt"));
