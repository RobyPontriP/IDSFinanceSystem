<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptIncomeStatement.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptIncomeStatement" MasterPageFile="~/Report/Template/ReportMaster.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Income Statement Report</asp:Label>
    </h4>
        ...
        <div class="card-body">
            <!-- Mulai -->
             <div class="row mb-2">
                ...
                <div class="col-sm-4">
                     <div class="form-group row mb-2">
                        <asp:Label ID="Label4" runat="server" Text="Code" CssClass="control-label col-sm-3 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-4">
             ...
             <div class="row mb-2">
                  <div class="col-sm-4">
                      <div class="form-group row mb-2">
                          <asp:Label ID="Label3" runat="server" Text="Default" CssClass="control-label col-sm-3 col-form-label" Font-Bold="true"></asp:Label>
                          <div class="col-sm-4">
                               <asp:CheckBox ID="chkDefault" runat="server" Checked="true" />
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-sm-2">
                      <div class="form-group row mb-2">
                            <asp:Button runat="server" ID="btnPreview" Text="Preview" CausesValidation="false" ToolTip="Preview Report"
                                CssClass="btn btn-sm btn-default" OnClick="btnPreview_Click" />
                      </div>
                  </div>
