...
{
    public partial class wfRptBalanceSheetAllBranch : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/RptBalanceSheetAllBranch.rpt"));
                ...
                rpt.SetParameterValue("@pBranch", DBNull.Value);
        ...
        {
            this.Page.Title = "Balance Sheet All Branch Report";
