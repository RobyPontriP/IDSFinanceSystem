<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptBalanceSheetAllBranch.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptBalanceSheetAllBranch" MasterPageFile="~/Report/Template/ReportMaster.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Balance Sheet All Branch Report</asp:Label>
    </h4>
