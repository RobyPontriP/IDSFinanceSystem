<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptSummaryCashBasisUngroup.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptSummaryCashBasisUngroup" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Summary Cash Basis With BI Code Report</asp:Label>
    </h4>
                 ...
                 <div class="col-sm-3">
                     <div class="form-group row mb-2">
                          <label class="checkbox-inline">
                               <asp:CheckBox ID="chkPrintZeroAmt" runat="server" CssClass="form-check-inline" />Print Zero Amount
                          </label>
                     </div>
                     <div class="form-group row mb-2">
                         <label class="checkbox-inline">
                              <asp:CheckBox ID="chkPrintAllCol" runat="server" CssClass="form-check-inline" />Print All Field
                         </label>
                     </div>
                 </div>
