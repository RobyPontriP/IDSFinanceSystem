<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptSumTB.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptSumTB" MasterPageFile="~/Report/Template/ReportMaster.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Summary Trial Balance</asp:Label>
    </h4>
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-4">
                            <asp:TextBox ID="txtDtpPeriod" runat="server" CssClass="form-control form-control-sm bg-white col-sm-12"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group row mb-2">
                        <div class="form-check form-check-inline">
                            <asp:CheckBox ID="chkPrintZeroAmt" runat="server" CssClass="form-check-inline" />
                            <label class="form-check-label" for="inlineCheckbox3">Print Zero Amount</label>
                        </div>
                    </div>
                </div>
