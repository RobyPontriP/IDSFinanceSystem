...
{
    public partial class GLRepIncomeStatComparative : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    case "0301022700000000":
                        string judul_ = "Comparative Statements of Comprehensive Income";
                        ...
                        rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/GLRepIncomeStatComparative.rpt"));
        ...
        {
            cboXCode.DataSource = IDS.GLTable.RptGen.GetRptGenForDatasource().Where(x => x.Value.Substring(0, 1) == "P");
