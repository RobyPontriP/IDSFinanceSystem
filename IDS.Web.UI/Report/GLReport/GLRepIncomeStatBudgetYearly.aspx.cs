...
{
    public partial class GLRepIncomeStatBudgetYearly : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    case "0301022500000000":
                        string judul_ = "Income Statement";
                        ...
                        rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/GLRepIncomeStatBudgetYearly.rpt"));
