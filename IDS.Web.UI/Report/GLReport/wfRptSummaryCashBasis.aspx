<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptSummaryCashBasis.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptSummaryCashBasis" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Summary Cash Basis Report</asp:Label>
    </h4>
