<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptGEAdminExpenseCon.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptGEAdminExpenseCon" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-2">
                            <asp:DropDownList ID="cboCode" runat="server" CssClass="form-control form-control-sm"></asp:DropDownList>
                        </div>
