...
{
    public partial class wfRptSumTB : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/RptSumTrialBalance.rpt"));
        ...
        {
            this.Page.Title = "Summary Trial Balance Report";
