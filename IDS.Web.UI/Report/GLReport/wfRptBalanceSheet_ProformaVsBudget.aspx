<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptBalanceSheet_ProformaVsBudget.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptBalanceSheet_ProformaVsBudget" MasterPageFile="~/Report/Template/ReportMaster.Master"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="col-sm-8 col-md-8 col-6 mb-2">
        <h4>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 mb-2">
                    <div class="form-group row mb-2">
                        <label for="cboXYearFrom" class="col-sm-5 col-form-label col-form-label-sm">Proforma Period</label>
                        <div class="col-sm-7">
                            <asp:TextBox ID="cboXYearFrom" runat="server" CssClass="form-control form-control-sm bg-white"></asp:TextBox>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="<%=ResolveClientUrl("~/Scripts/moment.min.js") %>"></script>
    ...
    <script type="text/javascript">
          $(document).ready(function () {
            ...
            flatpickr("#<%=cboXYearFrom.ClientID %>", {
                dateFormat: "M Y",
                disableMobile:true,
                static: true,
