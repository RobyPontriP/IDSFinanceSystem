...
{
    public partial class wfRptSumCashBasisConsolidation : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/RptSummaryCashBasisConsolidation.rpt"));
        ...
        {
            this.Page.Title = "Summary Cash Basis Consolidation Report";
