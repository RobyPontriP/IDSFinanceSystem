<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptYearlyRatio.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptYearlyRatio" MasterPageFile="~/Report/Template/ReportMaster.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Yearly Ratio Report</asp:Label>
    </h4>
