<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptPaymentSchedule.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptPaymentSchedule" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group row mb-2">
                        <asp:Label ID="Label11" runat="server" Text="ACC From" CssClass="control-label col-sm-3 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-8">
                ...
                <div class="col-sm-2">
                    <div class="form-group row mb-2">
                        <asp:Label ID="Label2" runat="server" Text="Report of" CssClass="control-label col-sm-5 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-7">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group row mb-2">
                        <asp:Label ID="Label4" runat="server" Text="Rep. Office" CssClass="control-label col-sm-3 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-9">
                            <asp:DropDownList ID="cboRepOffice" runat="server" CssClass="form-control select2DDList"></asp:DropDownList>
                        </div>
                    </div>
                </div>
<%--                <div class="col-sm-1">
                    <div class="form-group row mb-2">
                        <asp:Label ID="Label6" runat="server" Text="Report Type" CssClass="control-label col-sm-12 col-form-label" Font-Bold="true"></asp:Label>
                    </div>
                </div>
                ...
                <div class="col-sm-1">
                    <div class="form-group row mb-2">
                        ...
                        <asp:Label ID="Label4" runat="server" Text="Detail" CssClass="control-label col-sm-7 col-form-label" Font-Bold="true"></asp:Label>
                    </div>
                </div>
                ...
                <div class="col-sm-1">
                    <div class="form-group row mb-2">
                        ...
                        <asp:Label ID="Label5" runat="server" Text="Summary" CssClass="control-label col-sm-9 col-form-label" Font-Bold="true"></asp:Label>
                    </div>
                </div>--%>
                ...
                <div class="col-sm-4">
                    <div class="form-group row mb-2">
                        <asp:Label ID="Label3" runat="server" Text="ACC To" CssClass="control-label col-sm-3 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-8">
                ...
                <div class="col-sm-2">
                    ...
                    <asp:Label ID="Label8" runat="server" Text="Enable Acc" CssClass="control-label col-sm-7 col-form-label" Font-Bold="true"></asp:Label>
                </div>
            </div>
        </div>
    </div>
