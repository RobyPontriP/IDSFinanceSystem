...
{
    public partial class wfRptGenAdminExpense : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                rpt.Load(Server.MapPath(@"~/Report/GLReport/CR/RptGeneralAdminExpense.rpt"));
        ...
        {
            this.Page.Title = "General & Administrative Report";
