<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptDetBal.aspx.cs" Inherits="IDS.Web.UI.Report.GLReport.wfRptDetBal" MasterPageFile="~/Report/Template/ReportMaster.Master" EnableEventValidation="false" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <h4>
        <asp:Label ID="lblTitle" runat="server" >Detail Trial Balance</asp:Label>
    </h4>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-2" style="justify-content: flex-start;">
                    <div class="form-group row mb-2">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <div class="form-group-inline row mb-2">
                        <asp:Label ID="Label8" runat="server" Text="Enable Filter" CssClass="control-label col-sm-6 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-2">
