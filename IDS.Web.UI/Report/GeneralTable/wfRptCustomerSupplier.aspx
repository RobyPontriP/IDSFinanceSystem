<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptCustomerSupplier.aspx.cs" Inherits="IDS.Web.UI.Report.GeneralTable.wfRptCustomerSupplier" MasterPageFile="~/Report/Template/ReportMaster.Master" %>
    ...
    <div class="card">
        ...
        <div class="card-body">
           ...
           <%--         <div class="form-group row mb-6">
                        <asp:Label ID="Label1" runat="server" Text="Choose" CssClass="control-label col-sm-2 col-form-label" Font-Bold="true"></asp:Label>
                        <div class="col-sm-5">
                            <asp:DropDownList ID="cboType" runat="server" CssClass="form-control select2DDList"></asp:DropDownList>
                        </div>
                    </div>--%>
                </div>
