<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptDepartment.aspx.cs" Inherits="IDS.Web.UI.Report.GeneralTable.wfRptDepartment" MasterPageFile="~/Report/Template/ReportMaster.Master" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row mb-6" runat="server" id="cboBranchASP">
