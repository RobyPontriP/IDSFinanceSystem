<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptMaster.aspx.cs" Inherits="IDS.Web.UI.Report.GeneralTable.wfRptMaster" MasterPageFile="~/Report/Template/ReportGeneralTableWithCode.Master"%>
...
<div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row mb-6" runat="server" id="cboBranchASP" style="display:none">
