<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptYear.aspx.cs" Inherits="IDS.Web.UI.Report.Sales.rptYear" MasterPageFile="~/Report/Template/ReportGeneralTableWithCode.Master" %>
        ...
        <div class="card-body">
           <div class="row mb-0">
            <div class="form-group row col-sm-4">
                ...
                <div class="col-sm-6">
                    <asp:Textbox AutoPostBack="false"  ID="txtDtpPeriod" runat="server" CssClass="form-control form-control-sm pl-15"></asp:Textbox>
                </div>
            </div>
