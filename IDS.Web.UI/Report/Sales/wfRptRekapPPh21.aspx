<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptRekapPPh21.aspx.cs" Inherits="IDS.Web.UI.Report.Sales.wfRptRekapPPh21" MasterPageFile="~/Report/Template/ReportMaster.Master"  %>
    ...
    <div class="card-body">
        ...
        <div class="row mb-0">
            ...
            <div class="form-group row col-sm-3">
                <label for="cboReportType" class="col-form-label col-form-label-sm col-sm-4">Report Type</label>
                <div class="col-sm-8">
                    <asp:DropDownList AutoPostBack="false"  ID="cboReportType" runat="server" CssClass="form-control form-control-sm pl-15 select2DDList"></asp:DropDownList>
                </div>
            </div>
