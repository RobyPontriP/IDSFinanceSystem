<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfRptAccrued.aspx.cs" Inherits="IDS.Web.UI.Report.Sales.CR.wfRptAccrued" MasterPageFile="~/Report/Template/ReportMaster.Master"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="col-sm-6 col-md-6 col-6">
        <h4>Secondary Unearned Report</h4>
    </div>
    ...
    <div class="row mb-0">
                <div class="form-group row col-sm-3">
                    <label for="cboMonth" class="col-form-label col-form-label-sm col-sm-3">Month/Year</label>
                    <div class="col-sm-9">
